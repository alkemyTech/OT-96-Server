const validateOrganization = (req, res, next) => {
    ...
    if((typeof name !== 'string')) 
        return res.status(400).json({ ok: false  , message:'El nombre de la organizacion es incorrecto' }
    )
    ...
    return res.status(400).json({ ok: false  , message:'EL texto de la organizacon es incorrecto' })
